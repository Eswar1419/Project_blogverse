...
const SignUp = () => {
    return (
        <div className='flex flex-col min-h-screen items-center '>
            <NavBar/>
            <form className=" flex flex-col mt-20 border-1 border-gray-400 w-1/3 items-center gap-5  mb-7 rounded-2xl  ">
                ...
                <div className="w-[90%] flex flex-col gp-2">
                    ...
                    <input type="email" placeholder='enter your password' className="border-1 text-gray-600 border-gray-700 w-full py-3 px-3 rounded-xl focus:outline-none " />
                </div>
